...
public class StdUnregisteredValueVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<SdfUnregisteredValue>
 {
  ...
  public StdUnregisteredValueVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public StdUnregisteredValueVector(global::System.Collections.Generic.IEnumerable<SdfUnregisteredValue> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (SdfUnregisteredValue element in c) {
      this.Add(element);
  ...
  public SdfUnregisteredValue[] ToArray() {
    SdfUnregisteredValue[] array = new SdfUnregisteredValue[this.Count];
    this.CopyTo(array);
    return array;
  }
