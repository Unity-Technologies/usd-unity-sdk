...
public class TfType : global::System.IDisposable {
  ...
  public uint GetNBaseTypes(TfType out_, uint maxBases) {
    uint ret = UsdCsPINVOKE.TfType_GetNBaseTypes(swigCPtr, TfType.getCPtr(out_), maxBases);
    return ret;
  }
  ...
  public void AddAlias(TfType base_, string name) {
    UsdCsPINVOKE.TfType_AddAlias(swigCPtr, TfType.getCPtr(base_), name);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public TfType Alias(TfType base_, string name) {
    TfType ret = new TfType(UsdCsPINVOKE.TfType_Alias(swigCPtr, TfType.getCPtr(base_), name), false);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
