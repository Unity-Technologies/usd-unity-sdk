...
public class TfTokenVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<TfToken>
 {
  ...
  public TfTokenVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public TfTokenVector(global::System.Collections.Generic.IEnumerable<TfToken> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (TfToken element in c) {
      this.Add(element);
  ...
  public TfToken[] ToArray() {
    TfToken[] array = new TfToken[this.Count];
    this.CopyTo(array);
    return array;
  }
