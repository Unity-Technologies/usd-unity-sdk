...
public class TfTypeVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<TfType>
 {
  ...
  public TfTypeVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public TfTypeVector(global::System.Collections.Generic.IEnumerable<TfType> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (TfType element in c) {
      this.Add(element);
  ...
  public TfType[] ToArray() {
    TfType[] array = new TfType[this.Count];
    this.CopyTo(array);
    return array;
  }
