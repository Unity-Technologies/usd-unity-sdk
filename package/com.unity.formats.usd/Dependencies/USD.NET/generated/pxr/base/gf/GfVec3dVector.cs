...
public class GfVec3dVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<GfVec3d>
 {
  ...
  public GfVec3dVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public GfVec3dVector(global::System.Collections.Generic.IEnumerable<GfVec3d> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (GfVec3d element in c) {
      this.Add(element);
  ...
  public GfVec3d[] ToArray() {
    GfVec3d[] array = new GfVec3d[this.Count];
    this.CopyTo(array);
    return array;
  }
