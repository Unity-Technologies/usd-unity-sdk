...
public class UsdTimeCodeVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdTimeCode>
 {
  ...
  public UsdTimeCodeVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdTimeCodeVector(global::System.Collections.Generic.IEnumerable<UsdTimeCode> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdTimeCode element in c) {
      this.Add(element);
  ...
  public UsdTimeCode[] ToArray() {
    UsdTimeCode[] array = new UsdTimeCode[this.Count];
    this.CopyTo(array);
    return array;
  }
