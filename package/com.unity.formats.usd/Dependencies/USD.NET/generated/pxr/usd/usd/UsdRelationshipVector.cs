...
public class UsdRelationshipVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdRelationship>
 {
  ...
  public UsdRelationshipVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdRelationshipVector(global::System.Collections.Generic.IEnumerable<UsdRelationship> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdRelationship element in c) {
      this.Add(element);
  ...
  public UsdRelationship[] ToArray() {
    UsdRelationship[] array = new UsdRelationship[this.Count];
    this.CopyTo(array);
    return array;
  }
