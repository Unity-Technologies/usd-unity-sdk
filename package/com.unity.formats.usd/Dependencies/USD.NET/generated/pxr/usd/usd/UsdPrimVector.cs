...
public class UsdPrimVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdPrim>
 {
  ...
  public UsdPrimVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdPrimVector(global::System.Collections.Generic.IEnumerable<UsdPrim> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdPrim element in c) {
      this.Add(element);
  ...
  public UsdPrim[] ToArray() {
    UsdPrim[] array = new UsdPrim[this.Count];
    this.CopyTo(array);
    return array;
  }
