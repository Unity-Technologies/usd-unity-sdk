...
public class UsdPropertyVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdProperty>
 {
  ...
  public UsdPropertyVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdPropertyVector(global::System.Collections.Generic.IEnumerable<UsdProperty> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdProperty element in c) {
      this.Add(element);
  ...
  public UsdProperty[] ToArray() {
    UsdProperty[] array = new UsdProperty[this.Count];
    this.CopyTo(array);
    return array;
  }
