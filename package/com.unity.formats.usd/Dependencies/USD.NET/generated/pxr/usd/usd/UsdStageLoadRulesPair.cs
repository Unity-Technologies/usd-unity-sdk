...
public class UsdStageLoadRulesPair : global::System.IDisposable {
  ...
  public UsdStageLoadRulesPair(SdfPath first, UsdStageLoadRules.Rule second) : this(UsdCsPINVOKE.new_UsdStageLoadRulesPair__SWIG_1(SdfPath.getCPtr(first), (int)second), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public UsdStageLoadRulesPair(UsdStageLoadRulesPair other) : this(UsdCsPINVOKE.new_UsdStageLoadRulesPair__SWIG_2(UsdStageLoadRulesPair.getCPtr(other)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
