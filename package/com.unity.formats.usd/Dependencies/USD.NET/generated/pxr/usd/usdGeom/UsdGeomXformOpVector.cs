...
public class UsdGeomXformOpVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdGeomXformOp>
 {
  ...
  public UsdGeomXformOpVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdGeomXformOpVector(global::System.Collections.Generic.IEnumerable<UsdGeomXformOp> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdGeomXformOp element in c) {
      this.Add(element);
  ...
  public UsdGeomXformOp[] ToArray() {
    UsdGeomXformOp[] array = new UsdGeomXformOp[this.Count];
    this.CopyTo(array);
    return array;
  }
