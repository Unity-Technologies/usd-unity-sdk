...
public class UsdShadeInputVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdShadeInput>
 {
  ...
  public UsdShadeInputVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdShadeInputVector(global::System.Collections.Generic.IEnumerable<UsdShadeInput> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdShadeInput element in c) {
      this.Add(element);
  ...
  public UsdShadeInput[] ToArray() {
    UsdShadeInput[] array = new UsdShadeInput[this.Count];
    this.CopyTo(array);
    return array;
  }
