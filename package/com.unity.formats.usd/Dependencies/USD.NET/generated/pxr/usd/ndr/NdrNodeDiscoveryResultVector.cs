...
public class NdrNodeDiscoveryResultVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<NdrNodeDiscoveryResult>
 {
  ...
  public NdrNodeDiscoveryResultVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public NdrNodeDiscoveryResultVector(global::System.Collections.Generic.IEnumerable<NdrNodeDiscoveryResult> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (NdrNodeDiscoveryResult element in c) {
      this.Add(element);
  ...
  public NdrNodeDiscoveryResult[] ToArray() {
    NdrNodeDiscoveryResult[] array = new NdrNodeDiscoveryResult[this.Count];
    this.CopyTo(array);
    return array;
  }
