...
public class UsdSkelInbetweenShapeVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdSkelInbetweenShape>
 {
  ...
  public UsdSkelInbetweenShapeVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdSkelInbetweenShapeVector(global::System.Collections.Generic.IEnumerable<UsdSkelInbetweenShape> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdSkelInbetweenShape element in c) {
      this.Add(element);
  ...
  public UsdSkelInbetweenShape[] ToArray() {
    UsdSkelInbetweenShape[] array = new UsdSkelInbetweenShape[this.Count];
    this.CopyTo(array);
    return array;
  }
