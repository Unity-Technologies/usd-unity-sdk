...
public class UsdSkelBindingVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<UsdSkelBinding>
 {
  ...
  public UsdSkelBindingVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public UsdSkelBindingVector(global::System.Collections.Generic.IEnumerable<UsdSkelBinding> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (UsdSkelBinding element in c) {
      this.Add(element);
  ...
  public UsdSkelBinding[] ToArray() {
    UsdSkelBinding[] array = new UsdSkelBinding[this.Count];
    this.CopyTo(array);
    return array;
  }
