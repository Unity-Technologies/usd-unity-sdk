...
public class SdfPropertySpecHandleVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<SdfPropertySpecHandle>
 {
  ...
  public SdfPropertySpecHandleVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public SdfPropertySpecHandleVector(global::System.Collections.Generic.IEnumerable<SdfPropertySpecHandle> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (SdfPropertySpecHandle element in c) {
      this.Add(element);
  ...
  public SdfPropertySpecHandle[] ToArray() {
    SdfPropertySpecHandle[] array = new SdfPropertySpecHandle[this.Count];
    this.CopyTo(array);
    return array;
  }
