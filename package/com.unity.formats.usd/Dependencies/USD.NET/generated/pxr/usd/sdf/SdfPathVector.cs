...
public class SdfPathVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<SdfPath>
 {
  ...
  public SdfPathVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public SdfPathVector(global::System.Collections.Generic.IEnumerable<SdfPath> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (SdfPath element in c) {
      this.Add(element);
  ...
  public SdfPath[] ToArray() {
    SdfPath[] array = new SdfPath[this.Count];
    this.CopyTo(array);
    return array;
  }
