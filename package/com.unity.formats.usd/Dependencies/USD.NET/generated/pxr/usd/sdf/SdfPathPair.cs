...
public class SdfPathPair : global::System.IDisposable {
  ...
  public SdfPathPair(SdfPath first, SdfPath second) : this(UsdCsPINVOKE.new_SdfPathPair__SWIG_1(SdfPath.getCPtr(first), SdfPath.getCPtr(second)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public SdfPathPair(SdfPathPair other) : this(UsdCsPINVOKE.new_SdfPathPair__SWIG_2(SdfPathPair.getCPtr(other)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
