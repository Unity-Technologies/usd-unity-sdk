...
public class SdfLayer : global::System.IDisposable {
  ...
  public bool ImportFromString(string string_) {
    bool ret = UsdCsPINVOKE.SdfLayer_ImportFromString(swigCPtr, string_);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public StdStringSet GetExternalReferences() {
    StdStringSet ret = new StdStringSet(UsdCsPINVOKE.SdfLayer_GetExternalReferences(swigCPtr), true);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public StdStringSet GetCompositionAssetDependencies() {
    StdStringSet ret = new StdStringSet(UsdCsPINVOKE.SdfLayer_GetCompositionAssetDependencies(swigCPtr), true);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool UpdateCompositionAssetDependency(string oldAssetPath, string newAssetPath) {
    bool ret = UsdCsPINVOKE.SdfLayer_UpdateCompositionAssetDependency__SWIG_0(swigCPtr, oldAssetPath, newAssetPath);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool UpdateCompositionAssetDependency(string oldAssetPath) {
    bool ret = UsdCsPINVOKE.SdfLayer_UpdateCompositionAssetDependency__SWIG_1(swigCPtr, oldAssetPath);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public StdStringSet GetExternalAssetDependencies() {
    StdStringSet ret = new StdStringSet(UsdCsPINVOKE.SdfLayer_GetExternalAssetDependencies(swigCPtr), true);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static StdStringSet GetMutedLayers() {
    StdStringSet ret = new StdStringSet(UsdCsPINVOKE.SdfLayer_GetMutedLayers(), true);
    return ret;
  }
  ...
  public void SetStateDelegate(SWIGTYPE_p_TfDeclarePtrsT_SdfLayerStateDelegateBase_t__RefPtr delegate_) {
    UsdCsPINVOKE.SdfLayer_SetStateDelegate(swigCPtr, SWIGTYPE_p_TfDeclarePtrsT_SdfLayerStateDelegateBase_t__RefPtr.getCPtr(delegate_));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
