...
public class TaskCallbackVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<TaskCallback>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          UsdCsPINVOKE.delete_TaskCallbackVector(swigCPtr);
        }
  ...
  public void Clear() {
    UsdCsPINVOKE.TaskCallbackVector_Clear(swigCPtr);
  }

  public void Add(TaskCallback x) {
    UsdCsPINVOKE.TaskCallbackVector_Add(swigCPtr, TaskCallback.getCPtr(x));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = UsdCsPINVOKE.TaskCallbackVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = UsdCsPINVOKE.TaskCallbackVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    UsdCsPINVOKE.TaskCallbackVector_reserve(swigCPtr, n);
  }

  public TaskCallbackVector() : this(UsdCsPINVOKE.new_TaskCallbackVector__SWIG_0(), true) {
  }

  public TaskCallbackVector(TaskCallbackVector other) : this(UsdCsPINVOKE.new_TaskCallbackVector__SWIG_1(TaskCallbackVector.getCPtr(other)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public TaskCallbackVector(int capacity) : this(UsdCsPINVOKE.new_TaskCallbackVector__SWIG_2(capacity), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  private TaskCallback getitemcopy(int index) {
    TaskCallback ret = new TaskCallback(UsdCsPINVOKE.TaskCallbackVector_getitemcopy(swigCPtr, index), true);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private TaskCallback getitem(int index) {
    TaskCallback ret = new TaskCallback(UsdCsPINVOKE.TaskCallbackVector_getitem(swigCPtr, index), false);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, TaskCallback val) {
    UsdCsPINVOKE.TaskCallbackVector_setitem(swigCPtr, index, TaskCallback.getCPtr(val));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(TaskCallbackVector values) {
    UsdCsPINVOKE.TaskCallbackVector_AddRange(swigCPtr, TaskCallbackVector.getCPtr(values));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public TaskCallbackVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = UsdCsPINVOKE.TaskCallbackVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, TaskCallback x) {
    UsdCsPINVOKE.TaskCallbackVector_Insert(swigCPtr, index, TaskCallback.getCPtr(x));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, TaskCallbackVector values) {
    UsdCsPINVOKE.TaskCallbackVector_InsertRange(swigCPtr, index, TaskCallbackVector.getCPtr(values));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    UsdCsPINVOKE.TaskCallbackVector_RemoveAt(swigCPtr, index);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    UsdCsPINVOKE.TaskCallbackVector_RemoveRange(swigCPtr, index, count);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public static TaskCallbackVector Repeat(TaskCallback value, int count) {
    global::System.IntPtr cPtr = UsdCsPINVOKE.TaskCallbackVector_Repeat(TaskCallback.getCPtr(value), count);
    TaskCallbackVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new TaskCallbackVector(cPtr, true);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    UsdCsPINVOKE.TaskCallbackVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    UsdCsPINVOKE.TaskCallbackVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, TaskCallbackVector values) {
    UsdCsPINVOKE.TaskCallbackVector_SetRange(swigCPtr, index, TaskCallbackVector.getCPtr(values));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
