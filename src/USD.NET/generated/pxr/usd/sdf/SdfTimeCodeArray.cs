...
public class SdfTimeCodeArray : Vt_ArrayBase {
  ...
  public SdfTimeCodeArray(Vt_ArrayForeignDataSource foreignSrc, SdfTimeCode data, uint size, bool addRef) : this(UsdCsPINVOKE.new_SdfTimeCodeArray__SWIG_1(Vt_ArrayForeignDataSource.getCPtr(foreignSrc), SdfTimeCode.getCPtr(data), size, addRef), true) {
  }

  public SdfTimeCodeArray(Vt_ArrayForeignDataSource foreignSrc, SdfTimeCode data, uint size) : this(UsdCsPINVOKE.new_SdfTimeCodeArray__SWIG_2(Vt_ArrayForeignDataSource.getCPtr(foreignSrc), SdfTimeCode.getCPtr(data), size), true) {
  }

  public SdfTimeCodeArray(SdfTimeCodeArray other) : this(UsdCsPINVOKE.new_SdfTimeCodeArray__SWIG_3(SdfTimeCodeArray.getCPtr(other)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public SdfTimeCodeArray(uint n) : this(UsdCsPINVOKE.new_SdfTimeCodeArray__SWIG_5(n), true) {
  }

  public SdfTimeCodeArray(uint n, SdfTimeCode value) : this(UsdCsPINVOKE.new_SdfTimeCodeArray__SWIG_6(n, SdfTimeCode.getCPtr(value)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
