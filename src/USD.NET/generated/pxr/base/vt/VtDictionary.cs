...
public class VtDictionary : global::System.IDisposable {
  ...
  public SWIGTYPE_p_std__mapT_std__string_VtValue_std__lessT_std__string_t_t__size_type count(string key) {
    SWIGTYPE_p_std__mapT_std__string_VtValue_std__lessT_std__string_t_t__size_type ret = new SWIGTYPE_p_std__mapT_std__string_VtValue_std__lessT_std__string_t_t__size_type(UsdCsPINVOKE.VtDictionary_count(swigCPtr, key), true);
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void erase(SWIGTYPE_p_VtDictionary__IteratorT_std__mapT_std__string_VtValue_std__lessT_std__string_t_t_p_std__mapT_std__string_VtValue_std__lessT_std__string_t_t__iterator_t it) {
    UsdCsPINVOKE.VtDictionary_erase__SWIG_1(swigCPtr, SWIGTYPE_p_VtDictionary__IteratorT_std__mapT_std__string_VtValue_std__lessT_std__string_t_t_p_std__mapT_std__string_VtValue_std__lessT_std__string_t_t__iterator_t.getCPtr(it));
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
