...
public class VtVec4iArray : Vt_ArrayBase {
  ...
  public VtVec4iArray(uint n, GfVec4i value) : this(UsdCsPINVOKE.new_VtVec4iArray__SWIG_3(n, GfVec4i.getCPtr(value)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public VtVec4iArray(uint n) : this(UsdCsPINVOKE.new_VtVec4iArray__SWIG_4(n), true) {
  }
