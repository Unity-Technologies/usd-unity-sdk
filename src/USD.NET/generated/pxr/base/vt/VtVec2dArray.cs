...
public class VtVec2dArray : Vt_ArrayBase {
  ...
  public VtVec2dArray(Vt_ArrayForeignDataSource foreignSrc, GfVec2d data, uint size, bool addRef) : this(UsdCsPINVOKE.new_VtVec2dArray__SWIG_1(Vt_ArrayForeignDataSource.getCPtr(foreignSrc), GfVec2d.getCPtr(data), size, addRef), true) {
  }
  ...
  public VtVec2dArray(VtVec2dArray other) : this(UsdCsPINVOKE.new_VtVec2dArray__SWIG_3(VtVec2dArray.getCPtr(other)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }

  public VtVec2dArray(uint n) : this(UsdCsPINVOKE.new_VtVec2dArray__SWIG_5(n), true) {
  }

  public VtVec2dArray(uint n, GfVec2d value) : this(UsdCsPINVOKE.new_VtVec2dArray__SWIG_6(n, GfVec2d.getCPtr(value)), true) {
    if (UsdCsPINVOKE.SWIGPendingException.Pending) throw UsdCsPINVOKE.SWIGPendingException.Retrieve();
  }
