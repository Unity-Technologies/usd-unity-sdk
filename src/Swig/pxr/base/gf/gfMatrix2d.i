...
%ignore GfMatrix2d(const double m[2][2]);
%ignore GfMatrix2d::Set(const double m[2][2]);
%ignore GfMatrix2d::Get(double m[2][2]);
%ignore GfMatrix2d::GetArray;

%include <arrays_csharp.i>

WRAP_EQUAL(GfMatrix2d)
