...
if(${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
  ...
  list(APPEND UNITY_EXECUTABLE_PATHS "${UNITY}/Hub/Editor/${UNITY_VERSION}/Unity.app/Contents")
  list(APPEND UNITY_EXECUTABLE_PATHS "${UNITY}/Hub/Editor/${UNITY_VERSION}/Unity.app/Contents/MacOS")
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
